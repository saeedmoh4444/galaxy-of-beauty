...
export function PWAInstallPrompt(): JSX.Element {
  ...
  return (
    <div className="fixed bottom-20 start-4 end-4 z-50 mx-auto max-w-sm rounded-2xl bg-surface-elevated p-4 shadow-2xl border border-brand-200 dark:border-brand-800 animate-slide-up">
