      ...
      <header className="sticky top-0 z-40 border-b border-edge bg-white/80 backdrop-blur dark:border-gray-800 dark:bg-gray-950/80">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between gap-4 px-4">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            {/* Bell is the least essential on phones — the drawer has room for it later */}
            ...
            <Link
              href="/register"
              className="whitespace-nowrap rounded-lg bg-brand-600 px-3 py-2 text-sm font-medium text-white transition-colors hover:bg-brand-700"
            >
              {t('auth.register')}
            </Link>
          </div>
