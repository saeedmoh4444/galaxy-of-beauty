        ...
        {isLoading ? (
          ...
          <>
            ...
            <Card padding="lg" className="relative overflow-hidden">
              <div
                className={`absolute top-0 end-0 start-0 h-1.5 bg-linear-to-r ${status === 'COMPLETED' ? 'from-gray-400 to-gray-500' : status === 'CANCELLED' ? 'from-red-400 to-red-500' : 'from-brand-400 to-brand-600'}`}
              />
              <div className="pt-4">
