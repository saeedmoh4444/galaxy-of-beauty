...
const LEVELS = [
  {
    ...
    plan: [
      'تعلمي روتين العناية اليومي',
      'اكتشفي نوع بشرتكِ',
      'أساسيات المكياج اليومي',
      'كيف تختارين المنتجات المناسبة',
  ...
  },
  {
    ...
    desc: 'طوري روتينكِ',
    plan: [
      'طبقي روتين عناية متكامل',
      'تعلمي مكياج المناسبات',
      'جربي صبغات شعر منزلية',
      'اكتشفي عالم العطور',
      'تعلمي تقنيات العناية بالأظافر',
    ],
  },
  {
    key: 'advanced',
    ...
    plan: [
      'صممي روتين عناية شخصي',
      'أتقني المكياج الاحترافي',
      'تعلمي تسريحات شعر متقدمة',
      'فن مزج العطور',
      'تقنيات أظافر احترافية (nail art)',
    ],
  },
];
...
const TOPIC_TIPS: Record<string, string[]> = {
  'العناية بالبشرة': [
    'استخدمي غسول مناسب لنوع بشرتكِ',
    'لا تنسي واقي الشمس يومياً',
    'قشري بشرتكِ مرة أسبوعياً',
    'اشربي ٨ أكواب ماء يومياً',
    'جربي الماسكات الطبيعية',
  ],
  المكياج: [
    'ابدئي بكريم أساس مناسب',
    'تعلمي تقنية الكونتور الأساسية',
    'اختاري ألوان تناسب لون بشرتكِ',
    'استثمري في فرش مكياج جيدة',
    'أزيلي المكياج قبل النوم دائماً',
  ],
  'العناية بالشعر': [
    'اغسلي شعركِ ٢-٣ مرات أسبوعياً',
    'استخدمي بلسم بعد كل غسلة',
    'قصي أطراف شعركِ كل ٣ أشهر',
    'تجنبي الحرارة الزائدة',
    'جربي حمام زيت أسبوعي',
  ],
  الأظافر: [
    'رطبي البشرة حول الأظافر يومياً',
    'استخدمي مقوي أظافر',
    'تجنبي قضم الأظافر',
    'غيري طلاء الأظافر كل أسبوع',
    'استخدمي قفازات عند التنظيف',
  ],
  العطور: [
    'ضعي العطر على نقاط النبض',
    'لا تفركي العطر بعد وضعه',
    'خزني العطور في مكان بارد ومظلم',
    'جربي layering العطور',
    'اختاري عطر الصباح مختلف عن المساء',
  ],
  التغذية: [
    'تناولي فيتامين C لنضارة البشرة',
    'أضيفي أوميغا ٣ لشعر صحي',
    'قللي السكر لصحة البشرة',
    'تناولي البروتين لأظافر قوية',
    'اشربي الشاي الأخضر كمضاد أكسدة',
  ],
};
