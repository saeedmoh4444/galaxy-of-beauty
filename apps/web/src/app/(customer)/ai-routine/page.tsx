            ...
            <div className="grid gap-3 sm:grid-cols-2">
              {SKIN_TYPES.map((t) => (
                <button
                  ...
                  className={`rounded-xl border-2 p-4 text-right transition-all ${skinType === t.key ? 'border-brand-400 bg-brand-50 dark:bg-brand-950' : 'border-gray-200 dark:border-gray-700'}`}
                >
