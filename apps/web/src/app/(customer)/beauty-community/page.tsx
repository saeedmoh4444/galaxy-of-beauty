        ...
        <div className="grid gap-6 lg:grid-cols-3">
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <BeautyAlumniCard
                alumna={{
                  name: 'نورة',
                  graduationYear: '2025',
                  currentRole: 'مديرة صالون',
                  story: 'من خبيرة تجميل إلى مالكة صالون في سنة واحدة',
                }}
              />
            </div>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <BeautyTechnicianQuoteCard
                quote={{
                  text: 'الجمال يبدأ من الثقة — وثقتكِ تبدأ من العناية بنفسكِ',
                  author: 'نورة',
                  role: 'خبيرة تجميل',
                }}
              />
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <BeautyRoutineSwapCard
                swaps={[{ from: 'مرطب ثقيل', to: 'مرطب جل خفيف', reason: 'الصيف' }]}
              />
