    ...
    <DashboardLayout role="CUSTOMER">
      <div className="mx-auto max-w-5xl space-y-6">
        ...
        <div className="grid gap-3 sm:grid-cols-4">
          <Link href="/self-care"><Card hover padding="md" className="text-center"><span className="text-2xl">🌸</span><p className="text-xs font-medium mt-1">تقييم اليوم</p></Card></Link>
          <Link href="/cycle-tracker"><Card hover padding="md" className="text-center"><span className="text-2xl">📅</span><p className="text-xs font-medium mt-1">الدورة</p></Card></Link>
          <Link href="/skin-analysis"><Card hover padding="md" className="text-center"><span className="text-2xl">🔬</span><p className="text-xs font-medium mt-1">تحليل البشرة</p></Card></Link>
          <Link href="/wellness-tracker"><Card hover padding="md" className="text-center"><span className="text-2xl">🧘</span><p className="text-xs font-medium mt-1">العافية</p></Card></Link>
        </div>
      </div>
    </DashboardLayout>
  );
