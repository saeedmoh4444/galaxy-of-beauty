...
export default function PriceDropAlertsPage(): JSX.Element {
  ...
  const [tprice, setTprice] = useState(100);
        ...
        <Card padding="lg">
          ...
          <div className="grid gap-3 sm:grid-cols-3">
            {services.map((s: Record<string, unknown>) => (
              <div
                key={s.id as number}
                className="rounded-xl bg-green-50 dark:bg-green-950 p-3 text-center"
              >
          ...
          <div className="space-y-3">
            ...
            <div>
              ...
              <input
                ...
                step={10}
                value={tprice}
                onChange={(e) => setTprice(parseInt(e.target.value))}
