      ...
      <PageContainer width="wide">
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          <div className="lg:col-span-2 space-y-6">
            ...
            <SalonAmenities amenities={['wifi', 'parking', 'coffee', 'waiting_area', 'private_room', 'kids_corner']} />

            <div className="grid gap-4 sm:grid-cols-2">
              <PrayerRoomBadge amenities={['prayer_mats', 'abayas', 'qibla', 'wudu_area']} nextPrayer={{ name: 'العصر', time: '45 دقيقة' }} />
              <BeautyComparisonCard items={[
                { name: 'كريم A', emoji: '🧴', price: 120, rating: 4.5, pros: ['ترطيب عميق', 'يدوم 24 ساعة'], cons: ['ثقيل قليلاً'], best: true },
                { name: 'كريم B', emoji: '🧴', price: 80, rating: 4.0, pros: ['خفيف', 'سريع الامتصاص'], cons: ['ترطيب أقل'] },
              ]} />
            </div>

            <div className="grid gap-4 sm:grid-cols-2">
              <BeautyPriceDropHistoryCard drops={[
          ...
          <div className="space-y-6">
            ...
            <PriceAlertBadge serviceName="مانيكير سبا" currentPrice={120} targetPrice={80} isActive={false} />
          </div>
        </div>
      </PageContainer>
    </DashboardLayout>
