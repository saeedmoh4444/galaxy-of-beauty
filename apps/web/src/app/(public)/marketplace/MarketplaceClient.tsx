...
export default function MarketplaceClient({
  ...
  // Use SSR data as initial display, client data when available
  const items: any[] = data?.items ?? (isLoading ? initialProducts : []);
  const total: number = data?.total ?? (isLoading ? initialTotal : 0);
