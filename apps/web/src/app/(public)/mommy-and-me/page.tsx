  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-12">
      <div className="text-center mb-10">
        ...
        <h1 className="mt-6 text-4xl font-extrabold text-text-primary dark:text-gray-100">Mommy & Me</h1>
        ...
        {PACKAGES.map((pkg, i) => (
          <Card key={i} padding="lg" hover>
            <div className="text-center">
              ...
              <h3 className="mt-4 text-lg font-bold text-text-primary dark:text-gray-100">{pkg.title}</h3>
              ...
              <p className="text-xs text-text-tertiary">للشخصين</p>
      ...
      <div className="mt-16 text-center bg-gradient-to-r from-pink-50 to-purple-50 rounded-3xl p-12 dark:from-pink-950 dark:to-purple-950">
        ...
        <p className="mt-3 text-text-secondary max-w-md mx-auto">اشتري بطاقة هدية Mommy & Me واهدِ أمكِ أو ابنتكِ يوماً لا يُنسى من العناية والجمال</p>
