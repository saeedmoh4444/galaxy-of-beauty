...
const PACKAGES = [
  ...
  },
  {
    ...
    price: 600,
    services: ['مساج', 'حمام مغربي', 'عناية بالبشرة', 'مانيكير', 'باديكير'],
  },
];
    ...
    <div className="mx-auto max-w-5xl px-4 py-12">
      <div className="text-center mb-10">
        ...
        <p className="mt-4 text-lg text-text-secondary max-w-2xl mx-auto">
          لحظات جميلة تشاركينها مع ابنتكِ. باقات تجميل مصممة خصيصاً للأمهات وبناتهن — لأن الجمال
          يصبح أجمل عندما نتشاركه
        </p>
      </div>
