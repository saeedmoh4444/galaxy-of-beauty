...
const LOOKS = [
  {
    ...
    services: [
      ...
      { name: 'marketing.shop-the-look.service-hair-style', price: 300, duration: 60, emoji: '💇' },
      {
  ...
  },
  {
    ...
    services: [
      ...
      { name: 'marketing.shop-the-look.service-hair-style', price: 200, duration: 45, emoji: '💇' },
      { name: 'marketing.shop-the-look.service-lashes', price: 80, duration: 30, emoji: '👁' },
    ],
  },
  {
    id: 'spa',
  ...
  },
  {
    ...
    services: [
      ...
      { name: 'marketing.shop-the-look.service-work-hair', price: 120, duration: 30, emoji: '💇' },
  ...
  },
  {
    ...
    services: [
      {
        name: 'marketing.shop-the-look.service-photo-makeup',
        price: 400,
        duration: 90,
        emoji: '💄',
      },
      { name: 'marketing.shop-the-look.service-hair-style', price: 250, duration: 45, emoji: '💇' },
