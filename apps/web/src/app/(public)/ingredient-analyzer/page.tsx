...
export default function IngredientAnalyzerPage(): JSX.Element {
  ...
  ) as { data: { ingredients: Array<Record<string,unknown>>; stats: Record<string,number> } | undefined; isLoading: boolean; isError: boolean; refetch: () => void };
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12">
      ...
      <Card padding="lg" className="mb-6">
        ...
        <div className="mt-3 flex gap-2"><Button onClick={() => setSearchText(text.trim())} loading={isLoading} disabled={!text.trim()} className="flex-1">🧪 تحليل</Button></div>
      </Card>
