    ...
    return (
      <div className="mx-auto max-w-4xl px-4 py-12">
        <div className="text-center mb-10">
          ...
          <p className="mt-2 text-gray-500">بناءً على إجاباتكِ، هذه أفضل الهدايا المقترحة</p>
        </div>
            ...
            <Card key={r.id} padding="lg" className="hover:shadow-xl transition-all">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-500 mt-1">{r.descAr}</p>
  ...
  return (
    <div className="mx-auto max-w-lg px-4 py-12">
      <div className="text-center mb-8">
        ...
        <p className="mt-2 text-gray-500">أجيبي على الأسئلة لاكتشاف الهدية المثالية</p>
      </div>
      ...
      {currentQ && (
        <Card padding="lg">
          ...
          <p className="text-xs text-gray-400 mb-1">السؤال {step + 1} من {totalSteps}</p>
          ...
          <div className="space-y-2">
            {currentQ.options.map((opt) => (
              <button
                ...
                className="w-full rounded-xl border-2 border-gray-200 dark:border-gray-700 p-4 text-right hover:border-brand-400 hover:bg-brand-50 dark:hover:bg-brand-950 transition-all"
              >
                {opt.labelAr}
              </button>
            ))}
