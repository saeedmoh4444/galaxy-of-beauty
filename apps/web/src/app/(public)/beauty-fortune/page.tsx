...
export default function BeautyFortunePage(): JSX.Element {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-linear-to-br from-brand-50 via-pink-50 to-rose-50 px-4 dark:from-gray-950 dark:via-brand-950 dark:to-pink-950">
