...
const SEASONS = [
  ...
  { id: 'wedding', nameAr: 'موسم الأعراس', nameEn: 'Wedding Season', emoji: '👰', color: 'from-pink-400 to-rose-500' },
  { id: 'ramadan', nameAr: 'رمضان كريم', nameEn: 'Ramadan', emoji: '✨', color: 'from-purple-400 to-indigo-600' },
];

const LOOKS: Record<string, { title: string; desc: string; image: string; tags: string[]; link: string }[]> = {
  summer: [
    { title: 'إطلالة شاطئية منعشة', desc: 'مكياج خفيف مقاوم للماء مع تسريحة شاطئية', image: '🧴', tags: ['مكياج', 'شعر', 'عناية'], link: '/services' },
    { title: 'عناية بالبشرة قبل الصيف', desc: 'تقشير وترطيب عميق لبشرة متألقة', image: '✨', tags: ['بشرة', 'عناية'], link: '/services' },
    { title: 'ألوان الصيف الجريئة', desc: 'مانيكير وباديكير بألوان الموسم', image: '💅', tags: ['أظافر', 'مانيكير'], link: '/services' },
  ],
  eid: [
    { title: 'إطلالة العيد الفاخرة', desc: 'مكياج سهرة مع تسريحة أنيقة', image: '💄', tags: ['مكياج', 'شعر'], link: '/services' },
    { title: 'حناء العيد', desc: 'نقوش حناء عصرية للمناسبات', image: '🌿', tags: ['حناء', 'مناسبات'], link: '/services' },
    { title: 'بشرة متألقة للعيد', desc: 'جلسة عناية متكاملة قبل العيد', image: '✨', tags: ['بشرة', 'عناية'], link: '/services' },
  ],
  wedding: [
    { title: 'إطلالة العروس الكاملة', desc: 'مكياج، شعر، وأظافر ليومكِ الكبير', image: '👰', tags: ['عرايس', 'مكياج', 'شعر'], link: '/bridal-concierge' },
    { title: 'جلسة تصوير العروس', desc: 'مكياج احترافي يدوم طوال اليوم', image: '📸', tags: ['مكياج', 'تصوير'], link: '/services' },
    { title: 'إطلالة أم العروس', desc: 'مكياج ناعم وأنيق لأم العروس', image: '💐', tags: ['مكياج', 'مناسبات'], link: '/services' },
  ],
  ramadan: [
    { title: 'عناية مسائية في رمضان', desc: 'جلسات عناية بالبشرة بعد الإفطار', image: '🌙', tags: ['بشرة', 'عناية'], link: '/services' },
    { title: 'إطلالة السحور', desc: 'مكياج ناعم وطبيعي للسهرات الرمضانية', image: '✨', tags: ['مكياج', 'سهرات'], link: '/services' },
  ],
};
