...
const TECHNICIANS = [
  ...
  { id: 2, name: 'سارة الحربي', specialty: 'شعر', rating: 4.8, reviews: 189, price: 250, experience: '٦ سنوات', city: 'جدة', emoji: '💇‍♀️', services: ['تسريحات', 'صبغات', 'علاج شعر'], features: { speed: 85, quality: 92, price: 80, communication: 88 } },
  { id: 3, name: 'هند المطيري', specialty: 'أظافر', rating: 4.7, reviews: 156, price: 180, experience: '٥ سنوات', city: 'الدمام', emoji: '💅', services: ['مانيكير', 'باديكير', ' nail art'], features: { speed: 88, quality: 90, price: 90, communication: 85 } },
  { id: 4, name: 'د. ليلى القحطاني', specialty: 'بشرة', rating: 4.9, reviews: 312, price: 350, experience: '١٢ سنة', city: 'الرياض', emoji: '✨', services: ['تنظيف بشرة', 'تقشير', 'علاج حب الشباب'], features: { speed: 80, quality: 98, price: 60, communication: 95 } },
];

const DIMS: Record<string,string> = { speed: '⚡ السرعة', quality: '⭐ الجودة', price: '💰 السعر', communication: '💬 التواصل' };
