  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-12">
      <div className="mb-8 text-center">
        <ServiceImage
          service={pageHeroKey('tech-calendar')}
          alt=""
          size="xl"
          ...
          {tLoad ? (
            ...
            <div className="space-y-2 max-h-96 overflow-y-auto">
              {techs.map((tech: Record<string, unknown>) => (
                ...
                >
                  <div className="flex h-8 w-8 items-center justify-center rounded-full bg-linear-to-br from-brand-400 to-brand-500 text-white text-sm font-bold">
