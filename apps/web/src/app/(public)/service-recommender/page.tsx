...
export default function ServiceRecommenderPage(): JSX.Element {
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12">
      <div className="mb-8 text-center"><span className="text-6xl">🤖</span><h1 className="mt-4 text-3xl font-bold">اكتشفي خدماتكِ المثالية</h1><p className="mt-2 text-gray-500">أجيبي على ٣ أسئلة وسنقترح عليكِ أفضل خدمات الجمال المناسبة لكِ</p></div>
