...
export default function RegisterLoading(): JSX.Element {
  return (
    <div
      ...
      dir="rtl"
    >
      <div className="w-full max-w-lg rounded-2xl border border-edge bg-white p-8 shadow-sm dark:border-gray-700 dark:bg-gray-900">
        <div className="space-y-6">
          <div className="space-y-2 text-center">
            <div className="mx-auto h-10 w-48 animate-pulse rounded-lg bg-surface-muted" />
            <div className="mx-auto h-4 w-40 animate-pulse rounded bg-surface-muted" />
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-3">
              <div className="h-12 flex-1 animate-pulse rounded-lg bg-surface-muted" />
              <div className="h-12 flex-1 animate-pulse rounded-lg bg-surface-muted" />
            </div>
          </div>
