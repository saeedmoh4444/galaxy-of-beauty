...
export default function NotFound(): JSX.Element {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-white px-4 text-center dark:bg-gray-950">
      <img src="/logo.png" alt="جالكسي بيوتي" className="mb-8 h-20 w-20 rounded-2xl object-cover shadow-lg opacity-60" />
      <div className="mb-4 text-7xl">🔍</div>
      <h1 className="text-4xl font-extrabold text-gray-900 dark:text-gray-100">٤٠٤</h1>
      <p className="mt-3 text-lg text-gray-600 dark:text-gray-400">عذراً، الصفحة التي تبحثين عنها غير موجودة</p>
