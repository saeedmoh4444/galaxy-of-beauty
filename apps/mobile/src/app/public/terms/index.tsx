...
export default function TermsScreen(): JSX.Element {
  ...
  return (
    <ScrollView style={s.c} contentContainerStyle={s.i}>
      ...
      {[
        'مقدمة',
        'باستخدامكِ لمنصة دلال فإنكِ توافقين على الشروط والأحكام التالية. يرجى قراءتها بعناية.',
        'الحسابات',
        ...
        'المسؤولية',
        'دلال غير مسؤولة عن أي إصابات أو أضرار ناتجة عن الخدمات المقدمة من قبل الفنيات المستقلات.',
        'تواصل',
