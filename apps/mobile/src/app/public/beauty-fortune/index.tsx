  ...
  return (
    <ScrollView style={styles.c} contentContainerStyle={styles.i}>
      ...
      <View style={styles.card}>
        ...
        <TouchableOpacity onPress={getRandom} style={styles.btn}><Text style={styles.btnText}>🔮 جربي حظك</Text></TouchableOpacity>
      </View>
    </ScrollView>
  );
}
...
const styles = StyleSheet.create({
  c: { flex: 1, backgroundColor: '#fdf4ff' }, i: { padding: 16, paddingTop: 30, paddingBottom: 40, alignItems: 'center' },
  t: { fontSize: 24, fontWeight: '800', color: '#a21caf', textAlign: 'center', marginBottom: 20 },
  card: { backgroundColor: '#fff', borderRadius: 24, padding: 30, alignItems: 'center', width: '100%', borderWidth: 2, borderColor: '#f0abfc' },
  fortuneEmoji: { fontSize: 64, marginBottom: 16 },
  fortuneText: { fontSize: 18, fontWeight: '600', color: '#111827', textAlign: 'center', lineHeight: 28 },
  tip: { fontSize: 13, color: '#a21caf', marginTop: 16, textAlign: 'center' },
  btn: { backgroundColor: '#a21caf', borderRadius: 16, padding: 16, alignItems: 'center', marginTop: 20, width: '100%' },
