...
const styles = StyleSheet.create({
  ...
  homeBtn: { backgroundColor: '#6366f1', borderRadius: 14, paddingHorizontal: 24, paddingVertical: 14 },
  homeBt: { color: '#fff', fontSize: 14, fontWeight: '700' },
  backBtn: { backgroundColor: '#f3f4f6', borderRadius: 14, paddingHorizontal: 24, paddingVertical: 14 },
