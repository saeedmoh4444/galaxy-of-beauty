...
const INGREDIENTS: IngredientCard[] = [
  {
    ...
    bg: '#fff7ed',
    tips: [
      { emoji: '🌅', text: 'صباحاً — قبل واقي الشمس' },
  ...
  },
  {
    ...
    bg: '#ecfdf5',
    tips: [
      { emoji: '🧱', text: 'يعيد بناء حاجز البشرة' },
  ...
  },
  {
    ...
    tips: [
      ...
      { emoji: '🔁', text: 'يمكن استخدامها صباحاً ومساءً' },
  ...
  },
  {
    ...
    tips: [
      ...
      { emoji: '🚫', text: 'لا تخلطي أحماض مع ريتينول معاً' },
    ],
  },
  {
    emoji: '💦',
    ...
    tips: [
      ...
      { emoji: '✨', text: 'فوق المكياج — إشراقة منتصف اليوم' },
  ...
  },
  {
    ...
    tips: [
      ...
      { emoji: '📅', text: 'جلسة كل 4-6 أسابيع — 3-6 جلسات' },
  ...
  },
  {
    ...
    tips: [
      ...
      { emoji: '📅', text: '3-4 جلسات — بينها شهر' },
    ],
  },
  {
    emoji: '🐟',
  ...
  },
  {
    ...
    bg: '#f0fdfa',
    tips: [
      { emoji: '💍', text: 'البنصر — الأخف للتربيت' },
  ...
  },
  {
    ...
    tips: [
      ...
      { emoji: '⏳', text: 'الصبر — النتائج 8-12 أسبوعاً' },
    ],
  },
  {
    emoji: '🩹',
