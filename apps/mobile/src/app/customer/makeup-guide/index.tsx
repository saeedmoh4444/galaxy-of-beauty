...
const CARDS: Card[] = [
  {
    ...
    tips: [
      ...
      { emoji: '🧽', text: 'ادمجي بالإسفنجة — وليس الأصابع' },
    ],
  },
  {
    emoji: '🖌',
    ...
    tips: [
      ...
      { emoji: '💨', text: 'جففيها أفقياً — لا عمودياً' },
  ...
  },
  {
    ...
    tips: [
      ...
      { emoji: '🌀', text: 'ادمجي جيداً — لا خطوط قاسية' },
    ],
  },
  {
    emoji: '💋',
    ...
    tips: [
      ...
      { emoji: '👄', text: 'حددي الشفاه — يمنع التطاير' },
      { emoji: '💄', text: 'طبقتان — وامسحي الزائد بمنديل' },
    ],
  },
  {
    emoji: '🎨',
    ...
    tips: [
      ...
      { emoji: '🌀', text: 'امزجي جيداً — لا خطوط ظاهرة' },
  ...
  },
  {
    ...
    tips: [
      ...
      { emoji: '👀', text: 'ماسكارا بنية — طبيعية أكثر' },
  ...
  },
  {
    ...
    tips: [
      ...
      { emoji: '💗', text: 'قلب — جبهة عريضة ذقن مدبب' },
  ...
  },
  {
    ...
    tips: [
      ...
      { emoji: '💗', text: 'قلب: الذقن — لتقليصه بصرياً' },
    ],
  },
  {
    emoji: '🌺',
    ...
    tips: [
      ...
      { emoji: '💗', text: 'قلب: منخفض تحت تفاحة الخد' },
    ],
  },
  {
    emoji: '👀',
    ...
    tips: [
      ...
      { emoji: '💗', text: 'قلب: مقوسة — تلطف الجبهة' },
    ],
  },
  {
    emoji: '🫦',
    ...
    bg: '#fff1f2',
    tips: [
      { emoji: '👄', text: 'تحديد فوق الخط الطبيعي بقليل' },
  ...
  },
  {
    ...
    tips: [
      ...
      { emoji: '🌞', text: 'واقي شمس — الحفل في النهار' },
    ],
  },
  {
    emoji: '💘',
    ...
    tips: [
      ...
      { emoji: '👀', text: 'عيون سموكي ناعمة — ألوان دافئة' },
  ...
  },
  {
    ...
    bg: '#f0f9ff',
    tips: [
      { emoji: '🌞', text: 'SPF 50+ — البشرة الفاتحة تحترق بسرعة' },
  ...
  },
  {
    ...
    bg: '#fffbeb',
    tips: [
      { emoji: '🌞', text: 'SPF 30-50 — الميلانين يحمي جزئياً' },
  ...
  },
  {
    ...
    tips: [
      ...
      { emoji: '🌞', text: 'SPF 30+ — حماية ضرورية' },
    ],
  },
  {
    emoji: '🔍',
  ...
  },
  {
    ...
    tips: [
      ...
      { emoji: '🌞', text: 'ضوء طبيعي — الإضاءة تخدع' },
      { emoji: '⏰', text: 'انتظري 5 دقائق — اللون يتغير' },
  ...
  },
  {
    ...
    bg: '#f0f9ff',
    tips: [
      { emoji: '👀', text: 'رموش مرفوعة — لا تلمس العدسات' },
      { emoji: '✨', text: 'هايلايتر تحت الحاجب — يبرز العين' },
      { emoji: '🪶', text: 'ظلال مات — ليس لامعاً' },
      { emoji: '🪒', text: 'حاجبين مرتبين — الإطار يبرزهما' },
    ],
  },
  {
    emoji: '👁',
