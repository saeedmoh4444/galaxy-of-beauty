...
const CARDS: CareCard[] = [
  ...
  { emoji:'🦢',title:'عناية الرقبة',subtitle:'لا تهمليها — تظهر العمر قبل الوجه',color:'#d97706',bg:'#fffbeb',tips:[{emoji:'⬆️',text:'مددي منتجات الوجه للرقبة والصدر'},{emoji:'🧴',text:'كريمات مشدودة — ببتيدات وريتينول'},{emoji:'☀️',text:'واقي شمس — للرقبة أيضاً'},{emoji:'🛏️',text:'نامي على الظهر — تجاعيد الجانب'}]},
  { emoji:'✨',title:'عناية الصدر',subtitle:'منطقة مهملة — تستحق العناية',color:'#e11d48',bg:'#fff1f2',tips:[{emoji:'🧴',text:'نفس روتين وجهكِ — يمتد للصدر'},{emoji:'🧖',text:'تقشير لطيف — مرة أسبوعياً'},{emoji:'💧',text:'ترطيب بعد الاستحمام'},{emoji:'☀️',text:'SPF يومي — الصدر معرض للشمس'}]},
