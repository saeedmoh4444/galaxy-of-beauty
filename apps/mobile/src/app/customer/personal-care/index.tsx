...
const CARDS: CareCard[] = [
  ...
  },
  {
    ...
    tips: [
      ...
      { emoji: '️', text: '5-10 دقائق — مرتين أسبوعياً' },
  ...
  },
  {
    ...
    tips: [
      ...
      { emoji: '️', text: 'شمع — نتيجة تدوم 3-4 أسابيع' },
  ...
  },
  {
    ...
    tips: [
      ...
      { emoji: '️', text: 'دائماً للأعلى وللخارج — ضد الجاذبية' },
      { emoji: '🖐️', text: '5 تمريرات لكل منطقة — بلطف وليس بقوة' },
      { emoji: '️', text: 'خزني الحجر في الثلاجة — لانتعاش إضافي' },
    ],
  },
  {
    emoji: '⚡',
    ...
    tips: [
      ...
      { emoji: '️', text: 'للأعلى وللخارج — ضد الجاذبية' },
      { emoji: '️', text: '5-10 دقائق — 3-4 مرات أسبوعياً' },
  ...
  },
  {
    ...
    tips: [
      ...
      { emoji: '️', text: '3-5 دقائق — مرتين أسبوعياً' },
    ],
  },
  {
    emoji: '🦵',
  ...
  },
  {
    ...
    bg: '#f0fdfa',
    tips: [
      { emoji: '️', text: 'تجميد الدهون — كريوليبوليسز' },
  ...
  },
  {
    ...
    bg: '#fdf2f8',
    tips: [
      { emoji: '️', text: 'مكان بارد وجاف — ليس في الحمام' },
  ...
  },
  {
    ...
    tips: [
      ...
      { emoji: '️', text: 'أدراج مقسمة — كل فئة في درج' },
  ...
  },
  {
    ...
    tips: [
      ...
      { emoji: '️', text: 'حقيبة شفافة — للمطار' },
    ],
  },
  {
    emoji: '🧹',
    ...
    bg: '#ecfdf5',
    tips: [
      { emoji: '️', text: 'تخلصي من: تغير لون أو رائحة أو قوام' },
      { emoji: '📆', text: 'كل 3 أشهر — راجعي مجموعتكِ' },
      { emoji: '️', text: 'احتفظي بما تستخدمينه فعلاً' },
  ...
  },
  {
    ...
    bg: '#fffbeb',
    tips: [
      { emoji: '️', text: 'مددي منتجات الوجه للرقبة والصدر' },
      { emoji: '🧴', text: 'كريمات مشدودة — ببتيدات وريتينول' },
      { emoji: '️', text: 'واقي شمس — للرقبة أيضاً' },
      { emoji: '️', text: 'نامي على الظهر — تجاعيد الجانب' },
    ],
  },
  {
    emoji: '💗',
    ...
    tips: [
      ...
      { emoji: '️', text: 'SPF يومي — الصدر معرض للشمس' },
    ],
  },
  {
    emoji: '📱',
