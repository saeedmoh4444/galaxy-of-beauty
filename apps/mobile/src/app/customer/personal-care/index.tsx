...
const CARDS: CareCard[] = [
  {
    ...
    tips: [
      ...
      { emoji: '💄', text: 'تعبئة الفراغات — قلم حواجب بلون مطابق' },
  ...
  },
  {
    ...
    tips: [
      ...
      { emoji: '⏸️', text: 'استراحة — خذي استراحة من الرموش الصناعية' },
    ],
  },
  {
    emoji: '🧴',
    ...
    tips: [
      ...
      { emoji: '🌞', text: 'واقي للجسم — لا تنسي رقبتك ويديك وقدميك' },
  ...
  },
  {
    ...
    tips: [
      ...
      { emoji: '🩺', text: 'فحص دوري — كل 6 أشهر عند الطبيب' },
    ],
  },
  {
    emoji: '🛁',
    ...
    tips: [
      ...
      { emoji: '🌹', text: 'ماء الورد — لإنعاش بعد الحمام' },
    ],
  },
  {
    emoji: '🕯️',
    ...
    tips: [
      ...
      { emoji: '🌿', text: 'النعناع — للصداع وتنشيط الدورة' },
    ],
  },
  {
    emoji: '🪥',
    ...
    bg: '#fffbeb',
    tips: [
      { emoji: '🔼', text: 'من الأسفل للأعلى — دائماً باتجاه القلب' },
      { emoji: '🚿', text: 'قبل الاستحمام — على بشرة جافة تماماً' },
  ...
  },
  {
    ...
    tips: [
      ...
      { emoji: '⌛', text: '30 ثانية لكل منطقة — لا تطيلي' },
    ],
  },
  {
    emoji: '♨️',
    ...
    bg: '#fff1f2',
    tips: [
      { emoji: '🌿', text: 'أضيفي أعشاب — بابونج أو نعناع أو روزماري' },
      { emoji: '⏰', text: '5-10 دقائق — مرتين أسبوعياً' },
      { emoji: '📏', text: 'مسافة آمنة — 30 سم عن الوجه' },
      { emoji: '🧴', text: 'بعد البخار — سيروم أو مرطب فوراً' },
    ],
  },
  {
    emoji: '💤',
    ...
    bg: '#f5f3ff',
    tips: [
      { emoji: '💇', text: 'يمنع تكسر الشعر — احتكاك أقل من القطن' },
      { emoji: '😴', text: 'يمنع تجاعيد النوم — بشرة أنعم صباحاً' },
      { emoji: '🧴', text: 'يحافظ على ترطيب البشرة — لا يمتص الزيوت' },
      { emoji: '🧼', text: 'اغسليها كل أسبوع — بماء بارد وصابون لطيف' },
    ],
  },
  {
    emoji: '🪒',
    ...
    bg: '#fff1f2',
    tips: [
      { emoji: '🍯', text: 'حلاوة — طبيعية ألم أقل من الشمع' },
      { emoji: '🪒', text: 'شمع — نتيجة تدوم 3-4 أسابيع' },
      { emoji: '🔦', text: 'ليزر — نتيجة شبه دائمة 6 جلسات' },
      { emoji: '🧵', text: 'فتلة — للوجه دقيقة جداً' },
    ],
  },
  {
    emoji: '🥤',
    ...
    bg: '#ecfdf5',
    tips: [
      { emoji: '🍋', text: 'ليمون + نعناع — منعش يطرد السموم' },
      { emoji: '🍓', text: 'فراولة + ريحان — مضاد أكسدة بشرة مشرقة' },
      { emoji: '🥒', text: 'خيار + زنجبيل — مهدئ يقلل الالتهابات' },
      { emoji: '🍊', text: 'برتقال + قرفة — فيتامين C كولاجين طبيعي' },
    ],
  },
  {
    emoji: '💡',
    ...
    bg: '#f0f9ff',
    tips: [
      { emoji: '🔴', text: 'أحمر — كولاجين مضاد للشيخوخة' },
      { emoji: '🔵', text: 'أزرق — يقتل البكتيريا لعلاج الحبوب' },
      { emoji: '🟡', text: 'أصفر — يفتح البقع يقلل التصبغات' },
      { emoji: '🟢', text: 'أخضر — مهدئ يقلل الاحمرار' },
    ],
  },
  {
    emoji: '💎',
    ...
    bg: '#f0fdfa',
    tips: [
      { emoji: '🧴', text: 'زيت أو سيروم — لتزلق الأداة على البشرة' },
      { emoji: '🔼', text: 'دائماً للأعلى وللخارج — ضد الجاذبية' },
      { emoji: '🖐️', text: '5 تمريرات لكل منطقة — بلطف وليس بقوة' },
      { emoji: '🧊', text: 'خزني الحجر في الثلاجة — لانتعاش إضافي' },
    ],
  },
  {
    emoji: '⚡',
    ...
    bg: '#f0f9ff',
    tips: [
      { emoji: '💪', text: 'يحفز العضلات — يشد ملامح الوجه' },
      { emoji: '🔼', text: 'للأعلى وللخارج — ضد الجاذبية' },
      { emoji: '⏰', text: '5-10 دقائق — 3-4 مرات أسبوعياً' },
      { emoji: '🧴', text: 'جل موصل — ضروري لتوصيل التيار' },
    ],
  },
  {
    emoji: '📡',
    ...
    tips: [
      ...
      { emoji: '📅', text: 'جلسة 30-45 دقيقة — مرة شهرياً' },
  ...
  },
  {
    ...
    tips: [
      ...
      { emoji: '❄️', text: 'تدليك بارد — يقلل الانتفاخ تحت العين' },
      { emoji: '🌅', text: 'صباحاً — ينشط الدورة الدموية' },
      { emoji: '⏰', text: '3-5 دقائق — لا تطيلي على منطقة واحدة' },
    ],
  },
  {
    emoji: '🔊',
    ...
    tips: [
      ...
      { emoji: '🔼', text: 'حركي للأعلى — بطول المسام' },
  ...
  },
  {
    ...
    bg: '#f5f3ff',
    tips: [
      { emoji: '🦠', text: 'يجفف الحبوب — يقتل البكتيريا المسببة' },
      { emoji: '✨', text: 'يحسن الدورة الدموية — بشرة متوهجة' },
      { emoji: '🩹', text: 'على بشرة جافة — مع شاش واقي' },
      { emoji: '⏰', text: '3-5 دقائق — مرتين أسبوعياً' },
    ],
  },
  {
    emoji: '🦵',
  ...
  },
  {
    ...
    bg: '#f0fdfa',
    tips: [
      { emoji: '🧊', text: 'تجميد الدهون — كريوليبوليسز' },
      { emoji: '📡', text: 'راديو فريكونسي — حرارة تشد الجلد' },
      { emoji: '🔊', text: 'ألتراساوند — موجات تذيب الدهون' },
      { emoji: '💉', text: 'حقن — إذابة دهون موضعية' },
    ],
  },
  {
    emoji: '🧖',
    ...
    bg: '#ecfdf5',
    tips: [
      { emoji: '🏺', text: 'طين البحر — ينظف ويزيل السموم' },
      { emoji: '🍫', text: 'شوكولاتة — مضاد أكسدة يرطب وينعم' },
      { emoji: '🌿', text: 'أعشاب بحرية — يغذي وينشط البشرة' },
      { emoji: '☕', text: 'قهوة — كافيين يشد وينشط' },
    ],
  },
  {
    emoji: '💆',
    title: 'التصريف اللمفاوي',
    ...
    tips: [
      ...
      { emoji: '💪', text: 'يقوي المناعة — ينشط الجهاز اللمفاوي' },
  ...
  },
  {
    emoji: '📦',
    title: 'تخزين المكياج',
    subtitle: 'حافظي على منتجاتك نظيفة',
    color: '#ec4899',
    bg: '#fdf2f8',
    tips: [
      { emoji: '🧊', text: 'مكان بارد وجاف — ليس في الحمام' },
      { emoji: '🧰', text: 'منظمات أكريليك شفافة' },
      { emoji: '🌞', text: 'بعيداً عن الشمس — الضوء يدمر المنتجات' },
      { emoji: '📂', text: 'قسميها: يومي — أسبوعي — مناسبات' },
    ],
  },
  {
    emoji: '📆',
    ...
    bg: '#fffbeb',
    tips: [
      { emoji: '👁️', text: 'ماسكارا: 3-6 أشهر' },
      { emoji: '🧴', text: 'كريمات: 6-12 شهر بعد الفتح' },
      { emoji: '💄', text: 'بودرة: سنتان — الأطول عمراً' },
      { emoji: '💅', text: 'طلاء أظافر: سنة — يسمك مع الوقت' },
    ],
  },
  {
    emoji: '🪞',
    ...
    bg: '#f5f3ff',
    tips: [
      { emoji: '☀️', text: 'إضاءة طبيعية — قرب النافذة' },
      { emoji: '📦', text: 'أدراج مقسمة — كل فئة في درج' },
      { emoji: '🪞', text: 'مرآة مكبرة — للتفاصيل الدقيقة' },
      { emoji: '🧽', text: 'نظفي التسريحة أسبوعياً' },
    ],
  },
  {
    emoji: '🧳',
    title: 'تعبئة حقيبة السفر',
    subtitle: 'الأساسيات — بدون فوضى',
    color: '#0d9488',
    bg: '#f0fdfa',
    tips: [
      { emoji: '🧴', text: 'عبوات سفر صغيرة — أعيدي تعبئتها' },
      { emoji: '🎨', text: 'باليت متعدد — خدود + عيون + هايلايتر' },
      { emoji: '📝', text: 'قائمة أساسيات — لا تنسي شيئاً' },
      { emoji: '🛂', text: 'حقيبة شفافة — للمطار' },
    ],
  },
  {
    emoji: '🧹',
    title: 'ترتيب وتنظيف',
    subtitle: 'تخلصي من الفوضى',
    color: '#059669',
    bg: '#ecfdf5',
    tips: [
      { emoji: '🚮', text: 'تخلصي من: تغير لون أو رائحة أو قوام' },
      { emoji: '📆', text: 'كل 3 أشهر — راجعي مجموعتكِ' },
      { emoji: '✅', text: 'احتفظي بما تستخدمينه فعلاً' },
      { emoji: '🎁', text: 'تبرعي بالجديد غير المستخدم' },
    ],
  },
  {
    emoji: '🧣',
    ...
    bg: '#fffbeb',
    tips: [
      { emoji: '👐', text: 'مددي منتجات الوجه للرقبة والصدر' },
      { emoji: '🧴', text: 'كريمات مشدودة — ببتيدات وريتينول' },
      { emoji: '🌞', text: 'واقي شمس — للرقبة أيضاً' },
      { emoji: '🛌', text: 'نامي على الظهر — تجاعيد الجانب' },
    ],
  },
  {
    emoji: '💗',
    ...
    bg: '#fff1f2',
    tips: [
      { emoji: '🧴', text: 'نفس روتين وجهكِ — يمتد للصدر' },
      { emoji: '🧽', text: 'تقشير لطيف — مرة أسبوعياً' },
      { emoji: '🧴', text: 'ترطيب بعد الاستحمام' },
      { emoji: '🌞', text: 'SPF يومي — الصدر معرض للشمس' },
    ],
  },
  {
    emoji: '📱',
    ...
    tips: [
      ...
      { emoji: '🪑', text: 'وضعية الجلوس — ظهر مستقيم' },
  ...
  },
  {
    ...
    bg: '#f5f3ff',
    tips: [
      { emoji: '♻️', text: 'قناع سيليكون — يعاد استخدامه' },
      { emoji: '🎭', text: 'قناع ورقي للرقبة — مرة أسبوعياً' },
      { emoji: '⏰', text: '20-30 دقيقة — وقت الاسترخاء' },
  ...
  },
  {
    ...
    tips: [
      ...
      { emoji: '⬆️', text: 'مد الرقبة — انظري للسقف 10 ثوانٍ' },
  ...
  },
  {
    ...
    bg: '#fff1f2',
    tips: [
      { emoji: '💋', text: 'أحمر شفاه — لون محايد' },
      { emoji: '🧻', text: 'ورق نشاف — يزيل اللمعان' },
      { emoji: '🪞', text: 'مرآة صغيرة — للمسات السريعة' },
      { emoji: '🩹', text: 'لصقة حبوب — للطوارئ' },
    ],
  },
];
