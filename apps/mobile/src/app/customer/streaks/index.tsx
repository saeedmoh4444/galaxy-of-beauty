...
export default function StreaksScreen(): JSX.Element {
  ...
  return (
    <ScreenState isLoading={streak.isLoading} isError={streak.isError} isEmpty={!data} errorMessage="فشل تحميل الاستمرارية" onRetry={() => streak.refetch()}>
      <Text style={styles.title}>🔥 الاستمرارية</Text>
      <View style={styles.card}>
        <Text style={styles.fire}>🔥</Text>
        <Text style={styles.current}>الاستمرارية الحالية: {String(data?.currentStreak ?? 0)} أيام</Text>
