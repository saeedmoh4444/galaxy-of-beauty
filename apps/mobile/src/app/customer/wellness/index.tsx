...
const CARDS: Card[] = [
  {
    ...
    tips: [
      ...
      { emoji: '🌙', text: 'غرفة مظلمة وباردة — 18-20 درجة' },
  ...
  },
  {
    ...
    bg: '#f0f9ff',
    tips: [
      { emoji: '🌅', text: 'كوبان عند الاستيقاظ — ينشط الجسم' },
  ...
  },
  {
    ...
    tips: [
      ...
      { emoji: '🌅', text: 'صباحاً — 5 دقائق قبل بدء اليوم' },
  ...
  },
  {
    ...
    tips: [
      ...
      { emoji: '📝', text: 'اكتبي 3 أشياء ممتنة لها يومياً' },
  ...
  },
  {
    ...
    tips: [
      ...
      { emoji: '⏳', text: '3-6 أشهر — لرؤية نتائج واضحة' },
    ],
  },
  {
    emoji: '💉',
  ...
  },
  {
    ...
    tips: [
      ...
      { emoji: '💦', text: 'ماسكارا مقاومة للماء — ضرورية' },
