...
export default function BeautyRescueScreen(): JSX.Element {
  ...
  return (
    <ScrollView style={styles.c} contentContainerStyle={styles.i}>
      ...
      <Text style={{fontSize:20,fontWeight:'800',color:'#111827',marginTop:24,marginBottom:12}}>💡 نصائح SOS منزلية</Text>
      {[{emoji:'🚨',title:'طوارئ الحبوب',subtitle:'ظهور مفاجئ — حل سريع',color:'#ef4444',bg:'#fef2f2',tips:[{e:'🧊',t:'كمادة ثلج — 5 دقائق لتقليل الالتهاب'},{e:'💊',t:'لصقة حبوب — تجفف وتحمي من العبث'},{e:'🚫',t:'لا تضغطي — يزيد الالتهاب ويترك أثراً'},{e:'🧴',t:'كريم بنزويل بيروكسايد — للطوارئ'}]},{emoji:'🦞',title:'علاج حروق الشمس',subtitle:'إسعاف سريع للبشرة المحروقة',color:'#ea580c',bg:'#fff7ed',tips:[{e:'❄️',t:'كمادات باردة — 15 دقيقة كل ساعة'},{e:'🌿',t:'جل الألوفيرا — مبرد في الثلاجة'},{e:'💧',t:'اشربي ماء كثيراً — الترطيب من الداخل'},{e:'🚫',t:'لا تقشري — الجلد يتجدد طبيعياً'}]},{emoji:'👀',title:'انتفاخ العيون',subtitle:'صباح منتفخ — حل سريع',color:'#0284c7',bg:'#f0f9ff',tips:[{e:'🥄',t:'ملعقتان باردتان — على الجفون 5 دقائق'},{e:'🫖',t:'أكياس شاي أخضر — كافيين يقلص الانتفاخ'},{e:'🛏️',t:'وسادة مرتفعة — تقلل تجمع السوائل'},{e:'🧴',t:'كريم عيون بكافيين — نتائج فورية'}]},{emoji:'💋',title:'تشقق الشفاه',subtitle:'علاج سريع للشفاه الجافة',color:'#e11d48',bg:'#fff1f2',tips:[{e:'🍯',t:'مقشر سكر + عسل — مرة أسبوعياً'},{e:'🧴',t:'بلسم بفيتامين E — كل ساعتين'},{e:'💧',t:'اشربي ماء — الجفاف يبدأ من الداخل'},{e:'🚫',t:'لا تلعقي شفاهكِ — اللعاب يزيد الجفاف'}]},{emoji:'🔴',title:'تهدئة الاحمرار',subtitle:'بشرة هادئة في دقائق',color:'#059669',bg:'#ecfdf5',tips:[{e:'🧊',t:'ماء بارد — يغسل الوجه ويقلص الأوعية'},{e:'🌿',t:'جل الألوفيرا — مهدئ طبيعي فوري'},{e:'🛑',t:'أوقفي المنتجات النشطة — يوم راحة'},{e:'🧴',t:'مرطب بسيط — بدون عطور أو أحماض'}]}].map((c,i)=>(<View key={i} style={[styles.card,{borderColor:c.color+'30'}]}><View style={{flexDirection:'row',alignItems:'center',gap:10,marginBottom:8}}><Text style={{fontSize:24}}>{c.emoji}</Text><View style={{flex:1}}><Text style={{fontSize:14,fontWeight:'700',color:c.color}}>{c.title}</Text><Text style={{fontSize:11,color:'#9ca3af'}}>{c.subtitle}</Text></View></View>{c.tips.map((t:any,j:number)=>(<View key={j} style={{flexDirection:'row',alignItems:'center',gap:6,borderRadius:8,paddingHorizontal:10,paddingVertical:8,marginBottom:4,backgroundColor:c.bg}}><Text style={{fontSize:12}}>{t.e}</Text><Text style={{fontSize:11,fontWeight:'500',color:c.color,flex:1,textAlign:'right'}}>{t.t}</Text></View>))}</View>))}
      <Text style={{fontSize:20,fontWeight:'800',color:'#111827',marginTop:24,marginBottom:12}}>💉 عناية ما بعد الإجراءات</Text>
      {[{emoji:'💉',title:'بعد البوتوكس',subtitle:'تعليمات ما بعد الحقن',color:'#0284c7',bg:'#f0f9ff',tips:[{e:'🚫',t:'لا تلمسي — لا تدلكي 24 ساعة'},{e:'🧍',t:'ابقِ رأسك مرفوعاً — 4 ساعات'},{e:'🏃',t:'لا رياضة — 24 ساعة'},{e:'⏱️',t:'النتيجة النهائية — 10-14 يوم'}]},{emoji:'💉',title:'بعد الفيلر',subtitle:'عناية ما بعد التعبئة',color:'#7c3aed',bg:'#f5f3ff',tips:[{e:'🧊',t:'كمادات باردة — لتقليل التورم'},{e:'🚫',t:'تجنبي الضغط — لا تنامي على الوجه'},{e:'💄',t:'لا مكياج — 24 ساعة'},{e:'⏱️',t:'النتيجة النهائية — بعد أسبوعين'}]},{emoji:'⚡',title:'بعد الليزر',subtitle:'عناية خاصة بعد جلسة الليزر',color:'#ef4444',bg:'#fef2f2',tips:[{e:'☀️',t:'تجنبي الشمس — أسبوع كامل'},{e:'🧴',t:'SPF 50+ — ضرورة مطلقة'},{e:'🚫',t:'لا تقشري — 5 أيام'},{e:'💧',t:'مرطب لطيف — ألوفيرا أو بانثينول'}]},{emoji:'🧪',title:'بعد التقشير',subtitle:'روتين ما بعد التقشير الكيميائي',color:'#d97706',bg:'#fffbeb',tips:[{e:'💧',t:'ترطيب مكثف — كريمات مهدئة'},{e:'🚫',t:'لا تقشري الجلد — اتركيه يسقط'},{e:'☀️',t:'SPF 50+ — البشرة حساسة جداً'},{e:'📅',t:'لا ريتينول — لمدة أسبوع'}]},{emoji:'🕯️',title:'بعد إزالة الشعر',subtitle:'بشرة ناعمة — بدون التهاب',color:'#ec4899',bg:'#fdf2f8',tips:[{e:'🧴',t:'كريم مهدئ — ألوفيرا أو بانثينول'},{e:'🚫',t:'لا تعرقي — 24 ساعة بدون رياضة'},{e:'👚',t:'ملابس قطنية واسعة — للتهوية'},{e:'📅',t:'تقشير لطيف — بعد 3 أيام'}]}].map((c,i)=>(<View key={i} style={[styles.card,{borderColor:c.color+'30'}]}><View style={{flexDirection:'row',alignItems:'center',gap:10,marginBottom:8}}><Text style={{fontSize:24}}>{c.emoji}</Text><View style={{flex:1}}><Text style={{fontSize:14,fontWeight:'700',color:c.color}}>{c.title}</Text><Text style={{fontSize:11,color:'#9ca3af'}}>{c.subtitle}</Text></View></View>{c.tips.map((t:any,j:number)=>(<View key={j} style={{flexDirection:'row',alignItems:'center',gap:6,borderRadius:8,paddingHorizontal:10,paddingVertical:8,marginBottom:4,backgroundColor:c.bg}}><Text style={{fontSize:12}}>{t.e}</Text><Text style={{fontSize:11,fontWeight:'500',color:c.color,flex:1,textAlign:'right'}}>{t.t}</Text></View>))}</View>))}
    </ScrollView>
  );
}
