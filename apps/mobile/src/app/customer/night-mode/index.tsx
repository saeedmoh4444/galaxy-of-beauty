...
export default function NightModeScreen(): JSX.Element {
  ...
  return (
    <ScrollView
      style={[styles.c, enabled && styles.cDark]}
...
const styles = StyleSheet.create({
  ...
  st: { fontSize: 16, fontWeight: '700', color: '#111827', marginBottom: 8 },
  stDark: { color: '#e5e7eb' },
  ...
  previewText: { fontSize: 14, color: '#111827', fontWeight: '600' },
  previewTextDark: { color: '#e5e7eb' },
  hint: { fontSize: 12, color: '#9ca3af', textAlign: 'center', marginTop: 20 },
