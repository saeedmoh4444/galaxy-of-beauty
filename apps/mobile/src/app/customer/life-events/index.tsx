...
const CARDS: Card[] = [
  ...
  { emoji:'🩺',title:'تكيس المبايض',subtitle:'بشرة جميلة رغم الهرمونات',color:'#0d9488',bg:'#f0fdfa',tips:[{emoji:'🧴',text:'منتجات خالية من الزيوت — للبشرة الدهنية'},{emoji:'🔬',text:'نياسيناميد وزنك — لتنظيم الدهون'},{emoji:'🥗',text:'تغذية منخفضة السكر — تقلل الالتهابات'},{emoji:'🩺',text:'استشيري طبيبك — بعض العلاجات تحتاج وصفة'}]},
  { emoji:'🤰',title:'الآمن للحامل',subtitle:'منتجات آمنة لكِ ولطفلكِ',color:'#ec4899',bg:'#fdf2f8',tips:[{emoji:'✅',text:'مسموح: فيتامين C أزيليك هيالورونيك'},{emoji:'⚠️',text:'بحذر: حمض الساليسيليك أقل من 2%'},{emoji:'❌',text:'ممنوع: ريتينول هيدروكينون بوتوكس'},{emoji:'🩺',text:'اسألي طبيبتك قبل أي منتج جديد'}]},
  { emoji:'👶',title:'شعر ما بعد الولادة',subtitle:'تساقط طبيعي — لا تقلقي',color:'#7c3aed',bg:'#f5f3ff',tips:[{emoji:'📅',text:'يبدأ بعد 3-6 أشهر — يستمر 3-6 أشهر'},{emoji:'💆',text:'تدليك الفروة — يحفز نمو شعر جديد'},{emoji:'💊',text:'فيتامينات ما بعد الولادة — حديد وزنك'},{emoji:'✂️',text:'قصة أقصر — تخفف الثقل وتشجع النمو'}]},
  { emoji:'🌡️',title:'حول انقطاع الطمث',subtitle:'جمالكِ في مرحلة التغيير',color:'#d97706',bg:'#fffbeb',tips:[{emoji:'💧',text:'جفاف البشرة — انتقلي لكريمات أغنى'},{emoji:'🔴',text:'احمرار وهبات — منتجات مهدئة'},{emoji:'🛡️',text:'الكولاجين يقل — ببتيدات وسيراميد'},{emoji:'🧴',text:'SPF ضروري — التصبغات تزيد'}]},
  { emoji:'🔴',title:'حبوب هرمونية',subtitle:'علاج حبوب الذقن والفك',color:'#ef4444',bg:'#fef2f2',tips:[{emoji:'📍',text:'مكانها: الذقن والفك — علامة هرمونية'},{emoji:'🧴',text:'علاج: بنزويل بيروكسايد أو ساليسيليك'},{emoji:'🍬',text:'قللي السكر والألبان — تزيد الالتهاب'},{emoji:'🩺',text:'إذا استمرت — راجعي طبيبة للهرمونات'}]},
];
