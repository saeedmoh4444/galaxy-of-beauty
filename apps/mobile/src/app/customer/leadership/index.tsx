...
const CARDS: Card[] = [
  { emoji:'👑',title:'برنامج She Leads',subtitle:'تمكين المرأة في قطاع التجميل',color:'#7c3aed',bg:'#f5f3ff',tips:[{emoji:'📚',text:'تدريب: مهارات القيادة والإدارة'},{emoji:'💰',text:'دعم: قروض صغيرة لبدء مشروعكِ'},{emoji:'🤝',text:'شبكة: تواصلي مع رائدات أعمال'},{emoji:'🎓',text:'شهادة: اعتماد مهني في القيادة'}]},
  { emoji:'💼',title:'رائدة أعمال',subtitle:'ابدئي مشروعكِ في التجميل',color:'#d97706',bg:'#fffbeb',tips:[{emoji:'📋',text:'خطة عمل — نساعدكِ في كتابتها'},{emoji:'💰',text:'تمويل — حتى 100,000 ر.س'},{emoji:'🏠',text:'موقع — دعم إيجار أول 6 أشهر'},{emoji:'👩‍🏫',text:'إرشاد — مرشد شخصي لمدة سنة'}]},
  { emoji:'🌟',title:'قصص نجاح',subtitle:'نماذج ملهمة من مجتمعنا',color:'#db2777',bg:'#fdf2f8',tips:[{emoji:'👩',text:'نورة — افتتحت صالونها بعد 6 أشهر'},{emoji:'👩',text:'مها — 3 فروع في سنتين'},{emoji:'👩',text:'ريم — من عاملة لصاحبة علامة تجارية'},{emoji:'💫',text:'أنتِ القصة القادمة!'}]},
  { emoji:'🎯',title:'أهداف القيادة',subtitle:'خططي لمستقبلكِ المهني',color:'#059669',bg:'#ecfdf5',tips:[{emoji:'📅',text:'قصير المدى: دورة قيادة (3 أشهر)'},{emoji:'🎯',text:'متوسط المدى: مشروع صغير (سنة)'},{emoji:'🏆',text:'طويل المدى: 3 فروع (3 سنوات)'},{emoji:'👑',text:'الرؤية: علامة تجارية سعودية عالمية'}]},
];
