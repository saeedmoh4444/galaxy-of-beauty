...
const CARDS: Card[] = [
  {
    ...
    tips: [
      ...
      { emoji: '🧼', text: 'نظفي فرشك — أسبوعياً البكتيريا تتراكم' },
  ...
  },
  {
    ...
    tips: [
      ...
      { emoji: '🌞', text: 'اهتمي بالحماية من الشمس مبكراً' },
  ...
  },
  {
    ...
    bg: '#fff7ed',
    tips: [
      { emoji: '🌞', text: 'SPF 50+ يومياً — حتى في الظل' },
  ...
  },
  {
    ...
    bg: '#f0fdfa',
    tips: [
      { emoji: '🌞', text: 'الصباح — مرطب + واقي شمس' },
  ...
  },
  {
    ...
    tips: [
      ...
      { emoji: '💨', text: 'مرطب جو — أثناء النوم' },
  ...
  },
  {
    ...
    tips: [
      ...
      { emoji: '🧴', text: 'كريم سميك قبل الخروج' },
  ...
  },
  {
    ...
    tips: [
      ...
      { emoji: '🌞', text: 'عدم استخدام واقي شمس — سبب الشيخوخة' },
  ...
  },
  {
    ...
    tips: [
      ...
      { emoji: '🧼', text: 'عدم تنظيف الفرش — بكتيريا تسبب الحبوب' },
      { emoji: '🚫', text: 'تحديد الشفاه بلون أغمق بكثير' },
      { emoji: '💋', text: 'عيون ثقيلة + شفاه ثقيلة — اختاري واحداً' },
    ],
  },
  {
    emoji: '💇',
  ...
  },
  {
    ...
    bg: '#f5f3ff',
    tips: [
      { emoji: '🚫', text: 'لا تخلطي أكثر من 3 منتجات نشطة' },
