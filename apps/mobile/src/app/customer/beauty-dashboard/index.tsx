...
const COLORS = { brand: '#7c3aed', white: '#ffffff', gray400: '#6b7280', gray900: '#111827', success: '#10b981', warning: '#f59e0b' };
...
export default function BeautyDashboardScreen(): JSX.Element {
  ...
  return (
    <ScreenState isLoading={loyalty.isLoading} isError={loyalty.isError} isEmpty={!lData && !iData} errorMessage="فشل تحميل لوحة الجمال" onRetry={() => { loyalty.refetch(); insights.refetch(); }}>
...
const styles = StyleSheet.create({
  ...
  card: { backgroundColor: COLORS.white, borderRadius: 14, padding: 16, marginBottom: 8, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', shadowColor: '#000', shadowOpacity: 0.05, shadowRadius: 4, elevation: 2 },
