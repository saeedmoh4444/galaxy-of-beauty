...
const CARDS: Card[] = [
  ...
  },
  {
    ...
    tips: [
      ...
      { emoji: '👩‍🦯', text: 'خريطة حسية — وصف لكل منطقة' },
    ],
  },
  {
    emoji: '💖',
  ...
  },
  {
    ...
    tips: [
      ...
      { emoji: '🌍', text: 'تقلل النفايات — 70% أقل بلاستيك' },
      { emoji: '💄', text: 'أحمر شفاه — كريم أساس — عطور' },
      { emoji: '♻️', text: 'ارجعي الفارغة — لخصم على القادمة' },
    ],
  },
  {
    emoji: '🌿',
  ...
  },
  {
    ...
    tips: [
      ...
      { emoji: '🔍', text: 'ليس كل "طبيعي" خالٍ من التجارب' },
    ],
  },
  {
    emoji: '🌾',
    ...
    bg: '#fffbeb',
    tips: [
      { emoji: '🚫', text: 'بعض المنتجات تحتوي جلوتين' },
