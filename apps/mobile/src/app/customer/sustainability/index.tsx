...
const CARDS: Card[] = [
  ...
  { emoji:'🌱',title:'الجمال النباتي',subtitle:'خالٍ من المكونات الحيوانية',color:'#16a34a',bg:'#f0fdf4',tips:[{emoji:'🐰',text:'بدون شمع عسل، لانولين، كولاجين'},{emoji:'🌿',text:'بدائل: شمع الصويا، زبدة الشيا'},{emoji:'🔍',text:'ابحثي عن شعار Vegan Certified'},{emoji:'✨',text:'نباتي ≠ طبيعي — اقرئي المكونات'}]},
  { emoji:'☪️',title:'الجمال الحلال',subtitle:'منتجات متوافقة مع الشريعة',color:'#059669',bg:'#f0fdfa',tips:[{emoji:'🧴',text:'خالٍ من الكحول والمواد المحرمة'},{emoji:'💧',text:'قابل للوضوء — يمرر الماء للبشرة'},{emoji:'🔍',text:'شهادة حلال معتمدة'},{emoji:'🇸🇦',text:'منتجات حلال سعودية'}]},
  { emoji:'🐰',title:'بدون تجارب',subtitle:'جمال أخلاقي — بدون قسوة',color:'#ec4899',bg:'#fdf2f8',tips:[{emoji:'🐰',text:'شعار Leaping Bunny — المعيار الذهبي'},{emoji:'🌿',text:'PETA Certified — علامة موثوقة'},{emoji:'🇸🇦',text:'السعودية تمنع تجارب التجميل'},{emoji:'🔍',text:'ليس كل "طبيعي" خالٍ من التجارب'}]},
  { emoji:'🌾',title:'بدون جلوتين',subtitle:'للبشرة الحساسة للجلوتين',color:'#d97706',bg:'#fffbeb',tips:[{emoji:'🚫',text:'بعض المنتجات تحتوي جلوتين'},{emoji:'🔍',text:'تأكدي: قمح، شعير، شوفان'},{emoji:'✅',text:'معظم المنتجات خالية — لكن تأكدي'},{emoji:'🩺',text:'سيلياك؟ — استشيري طبيبك'}]},
  { emoji:'🌸',title:'بدون عطور',subtitle:'للبشرة الحساسة والمتحسسة',color:'#0284c7',bg:'#f0f9ff',tips:[{emoji:'🚫',text:'العطور — السبب الأول لتحسس البشرة'},{emoji:'🔍',text:'Fragrance-free ≠ Unscented'},{emoji:'✅',text:'مناسب للحساسية والإكزيما'},{emoji:'🧴',text:'منتجات طبية — غالباً خالية من العطور'}]},
];
