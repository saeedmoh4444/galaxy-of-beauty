          ...
          <SocketProvider>
            ...
            <Stack screenOptions={{ headerShown: false }}>
              ...
              <Stack.Screen
                ...
                options={{ title: 'توثيق البريد الإلكتروني' }}
              />
              ...
              <Stack.Screen
                ...
                options={{ title: 'الصناديق الشهرية' }}
              />
              <Stack.Screen
                name="customer/video/[bookingId]/index"
                options={{ title: 'استشارة فيديو' }}
              />
              <Stack.Screen
                name="customer/video/[bookingId]/room/index"
                options={{ title: 'غرفة الفيديو' }}
              />
