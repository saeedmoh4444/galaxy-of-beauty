...
// A4b — real WebRTC call on mobile. Shared by the customer and technician
// room screens; same signaling contract as web (video:join/signal/leave
// over the authenticated socket server). ICE servers (STUN/TURN) come from
// the server in the video:join ack — the constant below is only a fallback.
