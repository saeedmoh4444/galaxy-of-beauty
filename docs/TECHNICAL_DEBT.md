...
| P1-03 | Test coverage: Tier 1 endpoints (was 9.5%)       | ✅ 557 tests; auth 2FA, booking state machine (72% of bookings.ts), payments, wallet, token cleanup, socket server (94%), worker handlers; ratchet 52/66/44/52 enforced |
