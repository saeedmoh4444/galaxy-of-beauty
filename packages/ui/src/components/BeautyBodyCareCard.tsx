...
interface BeautyBodyCareCardProps { className?: string; }
    ...
    <div className={cn('rounded-2xl border border-teal-100 bg-white p-4 dark:border-teal-900 dark:bg-gray-900', className)}>
      <div className="flex items-center gap-2">
        ...
        <div>
          ...
          <p className="text-[10px] text-teal-500 dark:text-teal-400">بشرة ناعمة من الرأس للقدمين</p>
        </div>
      </div>
      <div className="mt-3 space-y-1.5">
        {TIPS.map((t, i) => (
          <div key={i} className="flex items-center gap-2 rounded-lg bg-teal-50 px-3 py-2 dark:bg-teal-950">
