...
export function BeautyPerfumeOudCard({ className = '' }: { className?: string }): JSX.Element {
  return (
    <div
      className={cn(
    ...
    >
      <div className="flex items-center gap-2">
        ...
        <div>
          <h4 className="text-sm font-bold text-amber-700 dark:text-amber-300">دهن العود</h4>
          <p className="text-[10px] text-amber-500 dark:text-amber-400">ملك العطور الشرقية</p>
        </div>
      </div>
