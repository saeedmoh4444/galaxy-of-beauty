    ...
    >
      ...
      <div className="mt-3 grid grid-cols-3 gap-2">
        <div className="rounded-xl bg-brand-50 p-2.5 text-center dark:bg-brand-950">
          <p className="text-lg font-bold text-brand-800 dark:text-brand-200">{entries}</p>
          <p className="text-[9px] text-brand-600 dark:text-brand-400">{entriesLabel}</p>
        </div>
      ...
      <div className="mt-3 rounded-xl bg-brand-50 p-3 dark:bg-brand-950">
        <p className="text-center text-[10px] font-bold text-brand-700 dark:text-brand-300">
          {moodQuestion}
        </p>
