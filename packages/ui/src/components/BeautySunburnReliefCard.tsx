...
export function BeautySunburnReliefCard({ className = '' }: { className?: string }): JSX.Element {
  return (
    <div
      className={cn(
      ...
      <div className="flex items-center gap-2">
        ...
        <div>
          ...
          <p className="text-[10px] text-orange-500 dark:text-orange-400">
            إسعاف سريع للبشرة المحروقة
          </p>
        </div>
      </div>
      <div className="mt-3 space-y-1">
        {[
          { emoji: '️', text: 'كمادات باردة — 15 دقيقة كل ساعة' },
          { emoji: '', text: 'جل الألوفيرا — مبرد في الثلاجة' },
          { emoji: '', text: 'اشربي ماء كثيراً — الترطيب من الداخل' },
          { emoji: '', text: 'لا تقشري — اتركي الجلد يتجدد طبيعياً' },
        ].map((t, i) => (
          <div
            key={i}
