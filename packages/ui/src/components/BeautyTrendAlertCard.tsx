...
export function BeautyTrendAlertCard({ trends, className = '' }: BeautyTrendAlertCardProps): JSX.Element | null {
        ...
        {trends.slice(0, 4).map((t, i) => (
          <div key={i} className="flex items-center gap-2 rounded-lg bg-rose-50 px-3 py-2 dark:bg-rose-950">
            ...
            <div className="flex-1 min-w-0">
              ...
              {t.description && <p className="text-[9px] text-rose-600 dark:text-rose-400">{t.description}</p>}
            </div>
