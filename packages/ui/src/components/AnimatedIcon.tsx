...
export function PulseDot({ color = '#ef4444', size = 10 }: { color?: string; size?: number }): JSX.Element {
  return (
...
export function Shimmer({ width = '100%', height = 16 }: { width?: string; height?: number }): JSX.Element {
  return (
    <div
