...
const EVENTS: Record<Event, EventDef> = {
  prom: { emoji: '💃', title: 'حفلة موسيقية', description: 'إطلالة راقية تخطف الأنظار', look: 'مكياج سهرة ناعم + تسريحة راقية' },
  graduation: { emoji: '🎓', title: 'حفل تخرج', description: 'إشراقة تليق بإنجازكِ', look: 'مكياج طبيعي + تسريحة أنيقة' },
  eid: { emoji: '🌙', title: 'عيد', description: 'إطلالة مبهجة للعيد', look: 'مكياج ناعم + ضفائر عصرية' },
  wedding_guest: { emoji: '💒', title: 'حضور زفاف', description: 'إطلالة أنيقة تليق بالمناسبة', look: 'مكياج راقٍ + تسريحة كلاسيكية' },
  birthday_party: { emoji: '🎂', title: 'حفلة ميلاد', description: 'إطلالة مميزة ليومكِ الخاص', look: 'مكياج لامع + تسريحة مميزة' },
};
  ...
  return (
    ...
    >
      ...
      <div className="mt-3 rounded-xl bg-white/60 p-3 dark:bg-gray-800/60">
        ...
        <p className="mt-1 text-xs text-text-primary dark:text-gray-100">
          {ev.look}
        </p>
      </div>
