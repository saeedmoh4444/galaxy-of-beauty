...
export function BeautyStretchMarksCard({ className = '' }: { className?: string }): JSX.Element {
  return (
    <div
      className={cn(
    ...
    >
      <div className="flex items-center gap-2">
        ...
        <div>
          <h4 className="text-sm font-bold text-purple-700 dark:text-purple-300">علامات التمدد</h4>
          <p className="text-[10px] text-purple-500 dark:text-purple-400">علاج وتخفيف الخطوط</p>
        </div>
      </div>
