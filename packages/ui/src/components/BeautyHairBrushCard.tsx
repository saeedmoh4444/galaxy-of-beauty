...
export function BeautyHairBrushCard({ className = '' }: { className?: string }): JSX.Element {
  return (
    <div
      className={cn(
    ...
    >
      <div className="flex items-center gap-2">
        ...
        <div>
          <h4 className="text-sm font-bold text-pink-700 dark:text-pink-300">تصفيف الشعر</h4>
          <p className="text-[10px] text-pink-500 dark:text-pink-400">نصائح لشعر صحي</p>
        </div>
      </div>
