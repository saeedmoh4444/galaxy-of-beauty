...
export function BeautyPostAcneMarksCard({ className = '' }: { className?: string }): JSX.Element {
  return (
    <div
      className={cn(
    ...
    >
      <div className="flex items-center gap-2">
        ...
        <div>
          ...
          <p className="text-[10px] text-amber-500 dark:text-amber-400">روتين لتوحيد لون البشرة</p>
        </div>
      </div>
      <div className="mt-3 space-y-1">
        {[
          ...
          { emoji: '', text: 'أحماض ألفا هيدروكسي — تقشير كيميائي' },
          { emoji: '️', text: 'الصبر — النتائج تحتاج 8-12 أسبوعاً' },
        ].map((t, i) => (
          <div
            key={i}
