...
const TIPS: Record<HairType, Record<Porosity, string[]>> = {
  straight: {
    low: ['شامبو منقي أسبوعياً', 'بلسم خفيف', 'تجنبي الزيوت الثقيلة'],
    medium: ['غسيل كل 2-3 أيام', 'بلسم متوسط', 'حماية من الحرارة'],
    high: ['شامبو مرطب', 'بلسم عميق', 'زيوت خفيفة على الأطراف'],
  },
  wavy: {
    low: ['شامبو منقي', 'بلسم خفيف', 'منتجات رغوة'],
    medium: ['غسيل يومين ورا بعض', 'بلسم متوسط', 'سيروم خفيف'],
    high: ['Co-wash', 'بلسم عميق', 'زيوت طبيعية'],
  },
  curly: {
    low: ['شامبو منقي شهرياً', 'Co-wash أسبوعياً', 'منتجات خفيفة'],
    medium: ['Co-wash', 'بلسم عميق', 'جل تصفيف'],
    high: ['Co-wash', 'قناع شعر أسبوعي', 'زيوت وكريمات'],
  },
  coily: {
    low: ['Co-wash', 'منتجات خفيفة', 'صبقة شعر'],
    medium: ['Co-wash', 'قناع عميق', 'زبدة شعر'],
    high: ['Co-wash', 'قناع أسبوعي', 'زيوت ثقيلة'],
  },
};

const LABELS: Record<HairType, string> = {
  straight: 'ناعم',
  wavy: 'مموج',
  curly: 'مجعد',
  coily: 'متعرج',
      ...
      <div className="flex items-center gap-2">
        ...
        <div>
          ...
          <p className="text-[10px] text-purple-500 dark:text-purple-400">
            {LABELS[hairType]} · مسامية{' '}
            {porosity === 'low' ? 'منخفضة' : porosity === 'high' ? 'عالية' : 'متوسطة'}
          </p>
        </div>
      </div>
