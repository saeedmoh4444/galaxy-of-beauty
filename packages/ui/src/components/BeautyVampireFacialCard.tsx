...
export function BeautyVampireFacialCard({ className = '' }: { className?: string }): JSX.Element {
  return (
    <div
      className={cn(
    ...
    >
      <div className="flex items-center gap-2">
        ...
        <div>
          <h4 className="text-sm font-bold text-red-700 dark:text-red-300">فيشل البلازما</h4>
          <p className="text-[10px] text-red-500 dark:text-red-400">PRP — بلازما دمكِ لجمالكِ</p>
        </div>
      </div>
