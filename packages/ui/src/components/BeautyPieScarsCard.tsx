...
export function BeautyPieScarsCard({ className = '' }: { className?: string }): JSX.Element {
  return (
    <div
      className={cn(
    ...
    >
      <div className="flex items-center gap-2">
        ...
        <div>
          ...
          <p className="text-[10px] text-rose-500 dark:text-rose-400">PIH و PIE — الفرق والعلاج</p>
        </div>
      </div>
