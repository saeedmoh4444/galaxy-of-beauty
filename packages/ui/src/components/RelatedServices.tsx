      ...
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
        {services.map((s) => (
          <button
            key={s.id}
            onClick={() => onSelect(s)}
            className="flex items-center gap-3 rounded-xl border border-edge bg-surface-elevated p-4 text-end transition-all hover:border-brand-300 hover:shadow-md dark:hover:border-brand-700"
          >
