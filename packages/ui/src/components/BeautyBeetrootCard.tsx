...
export function BeautyBeetrootCard({ className = '' }: { className?: string }): JSX.Element {
  return (
    <div
      className={cn(
    ...
    >
      <div className="flex items-center gap-2">
        ...
        <div>
          <h4 className="text-sm font-bold text-rose-700 dark:text-rose-300">عصير الشمندر</h4>
          <p className="text-[10px] text-rose-500 dark:text-rose-400">الإشراقة الوردية من الداخل</p>
        </div>
      </div>
