...
export function BeautyJadeRollerCard({ className = '' }: { className?: string }): JSX.Element {
  return (
    <div
      className={cn(
    ...
    >
      <div className="flex items-center gap-2">
        ...
        <div>
          ...
          <p className="text-[10px] text-emerald-500 dark:text-emerald-400">بكرة اليشم للوجه</p>
        </div>
      </div>
