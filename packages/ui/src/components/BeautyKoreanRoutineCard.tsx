...
export function BeautyKoreanRoutineCard({ className = '' }: { className?: string }): JSX.Element {
  return (
    <div
      className={cn(
    ...
    >
      <div className="flex items-center gap-2">
        ...
        <div>
          ...
          <p className="text-[10px] text-pink-500 dark:text-pink-400">الترتيب الصحيح للعناية</p>
        </div>
      </div>
      <div className="mt-3 space-y-1">
        {[
          { emoji: '1️⃣', text: 'زيت + غسول مائي — تنظيف مزدوج' },
