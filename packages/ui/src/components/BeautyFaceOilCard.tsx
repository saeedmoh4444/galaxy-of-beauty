...
export function BeautyFaceOilCard({ className = '' }: { className?: string }): JSX.Element {
  return (
    <div
      className={cn(
    ...
    >
      <div className="flex items-center gap-2">
        ...
        <div>
          <h4 className="text-sm font-bold text-amber-700 dark:text-amber-300">زيت الوجه</h4>
          <p className="text-[10px] text-amber-500 dark:text-amber-400">هل هو مناسب لبشرتك؟</p>
        </div>
      </div>
