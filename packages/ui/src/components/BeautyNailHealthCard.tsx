...
export function BeautyNailHealthCard({ className = '' }: { className?: string }): JSX.Element {
  return (
    <div
      className={cn(
    ...
    >
      <div className="flex items-center gap-2">
        ...
        <div>
          <h4 className="text-sm font-bold text-emerald-700 dark:text-emerald-300">صحة الأظافر</h4>
          <p className="text-[10px] text-emerald-500 dark:text-emerald-400">علامات تحذيرية</p>
        </div>
      </div>
