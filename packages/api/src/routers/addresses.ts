...
const updateAddressInputSchema = z
  .object({
    id: z.number().int().positive(),
  })
...
export const addressRouter = router({
  ...
  // -----------------------------------------------------------------------
  create: protectedProcedure.input(createAddressSchema).mutation(async ({ ctx, input }) => {
    try {
  ...
  // -----------------------------------------------------------------------
  update: protectedProcedure.input(updateAddressInputSchema).mutation(async ({ ctx, input }) => {
    try {
      // Verify ownership
  ...
  // -----------------------------------------------------------------------
  setDefault: protectedProcedure.input(idParam).mutation(async ({ ctx, input }) => {
    try {
