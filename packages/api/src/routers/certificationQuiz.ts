...
const QUIZZES = [
  { id: 'skincare', nameAr: 'أساسيات العناية بالبشرة', emoji: '✨', questions: [
    { q: 'كم مرة يجب تنظيف البشرة يومياً؟', opts: ['مرة', 'مرتين', '٣ مرات', '٤ مرات'], correct: 1 },
    { q: 'ما هو أهم منتج للعناية اليومية؟', opts: ['تونر', 'سيروم', 'واقي شمس', 'مقشر'], correct: 2 },
    { q: 'متى يفضل وضع المرطب؟', opts: ['قبل النوم فقط', 'صباحاً فقط', 'صباحاً ومساءً', 'مرة أسبوعياً'], correct: 2 },
  ]},
  { id: 'makeup', nameAr: 'فن المكياج', emoji: '💄', questions: [
    { q: 'ما هي أول خطوة في تطبيق المكياج؟', opts: ['كريم أساس', 'برايمر', 'كونسيلر', 'بودرة'], correct: 1 },
    { q: 'كم مدة صلاحية الماسكارا بعد الفتح؟', opts: ['شهر', '٣ أشهر', '٦ أشهر', 'سنة'], correct: 1 },
  ]},
];
