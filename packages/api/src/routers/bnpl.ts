import { z } from 'zod';
import { BNPL_MIN_AMOUNT, BNPL_MAX_AMOUNT, BNPL_MIN_INSTALLMENTS, BNPL_MAX_INSTALLMENTS, MS_PER_30_DAYS } from '@galaxy/shared';
...
const BNPL_PROVIDERS = [
  ...
  { key: 'tamara', nameAr: 'تمارا', nameEn: 'Tamara', emoji: '🌴', description: 'ادفعي بعد ٣٠ يوم أو قسطي على ٣ دفعات', maxAmount: BNPL_MAX_AMOUNT, processingFee: 0 },
];

const ELIGIBILITY = { eligible: true, maxAmount: 5000, minAmount: BNPL_MIN_AMOUNT, providers: BNPL_PROVIDERS };
