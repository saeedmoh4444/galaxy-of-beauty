...
export const payoutRouter = router({
  ...
  // -----------------------------------------------------------------------
  calculate: adminProcedure.input(createPayoutSchema).mutation(async ({ input }) => {
    try {
  ...
  // -----------------------------------------------------------------------
  process: adminProcedure.input(processPayoutSchema).mutation(async ({ input }) => {
    try {
  ...
  // -----------------------------------------------------------------------
  listForAdmin: adminProcedure.input(payoutQuerySchema).query(async ({ input }) => {
    try {
      ...
      if (input.periodStart || input.periodEnd) {
        ...
        if (input.periodStart)
          (where.createdAt as Record<string, unknown>).gte = new Date(input.periodStart);
        if (input.periodEnd)
          (where.createdAt as Record<string, unknown>).lte = new Date(input.periodEnd);
      }
