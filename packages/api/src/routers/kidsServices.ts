...
const KIDS_CATEGORIES = {
  baby: {
    ...
    subServices: [
      {
        id: 'bb1',
        nameAr: 'قص شعر أول مرة',
        nameEn: 'First Haircut',
        price: 80,
        durationMin: 15,
        ageMin: 0,
        emoji: '✂️',
  ...
  toddler: {
    ...
    subServices: [
      ...
      {
        id: 'td3',
        nameAr: 'مانيكير أطفال',
        nameEn: 'Kids Manicure',
        price: 60,
        durationMin: 20,
        ageMin: 4,
        emoji: '💅',
  ...
  kids: {
    ...
    subServices: [
      ...
      {
        id: 'kd3',
        nameAr: 'جلسة تعليم عناية',
        nameEn: 'Beauty Lesson',
        price: 120,
        durationMin: 40,
        ageMin: 7,
        emoji: '📚',
      ...
      {
        id: 'kd4',
        nameAr: 'تسريحة مناسبة',
        nameEn: 'Party Hairstyle',
        price: 110,
        durationMin: 30,
        ageMin: 7,
        emoji: '🎉',
  ...
  book: customerProcedure
    .input(
      z.object({
        ...
        childAge: z.number().min(0).max(17),
