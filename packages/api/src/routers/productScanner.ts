...
const PRODUCTS = [
  {
    ...
    safetyScore: 92,
    concerns: [],
    ingredients: ['Aqua', 'Glycerin', 'Cetearyl Alcohol', 'Dimethicone', 'Panthenol', 'Tocopherol'],
    allergens: [],
  },
  {
    barcode: '6291102345678',
    nameAr: 'واقي شمس SPF50',
  ...
  },
  {
    ...
    safetyScore: 98,
    concerns: [],
    ingredients: ['Ascorbic Acid', 'Aqua', 'Glycerin', 'Tocopherol', 'Ferulic Acid'],
    allergens: [],
  },
  {
    barcode: '6291105678901',
    ...
    imageUrl: null,
    safetyScore: 78,
    concerns: ['بارابين', 'عطور'],
    ingredients: ['Aqua', 'Paraffin', 'Copernicia Cerifera Cera', 'Parabens', 'Fragrance'],
    allergens: ['Parabens', 'Fragrance'],
  },
  {
    barcode: '6291106789012',
    nameAr: 'زيت شعر طبيعي',
  ...
  },
  {
    ...
    safetyScore: 97,
    concerns: [],
    ingredients: ['Rosa Damascena Flower Water', 'Aqua', 'Glycerin', 'Aloe Barbadensis Extract'],
    allergens: [],
  },
  {
    barcode: '6291108901234',
    nameAr: 'مقشر الوجه',
    nameEn: 'Face Scrub',
    brand: 'St. Ives',
    category: 'skincare',
    imageUrl: null,
    safetyScore: 65,
    concerns: ['جزيئات خشنة', 'قد تسبب تهيج'],
    ingredients: [
      'Aqua',
...
const ALTERNATIVES = [
  {
    id: 1,
    nameAr: 'مرطب عضوي خالي من العطور',
