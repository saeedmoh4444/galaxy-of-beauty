...
const SYNC_STATUS = { connected: false, lastSynced: null as string | null, upcomingEvents: 0, provider: 'google' as const };
...
export const calendarSyncRouter = router({
  ...
  upcoming: customerProcedure.query(() => [
    { id: 1, title: 'حجز مكياج', date: '2026-07-30T10:00:00', technician: 'نورة العمري', emoji: '💄' },
    { id: 2, title: 'تنظيف بشرة', date: '2026-08-02T14:00:00', technician: 'د. ليلى القحطاني', emoji: '✨' },
  ]),
});
