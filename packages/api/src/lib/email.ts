...
export async function sendPasswordResetEmail(
  ...
  const subject = isAr ? 'إعادة تعيين كلمة المرور - دلال' : 'Password Reset - Dalal';
  ...
  const html = isAr
    ? `
      <div dir="rtl" style="font-family: Tahoma, sans-serif; max-width: 480px; margin: auto; padding: 24px;">
        ...
        <p>لقد طلبتِ إعادة تعيين كلمة المرور لحسابك في <strong>دلال</strong>.</p>
        ...
        <p style="color: #9ca3af; font-size: 12px;">دلال — منصتكِ للجمال والعناية</p>
      </div>
    `
    : `
      <div style="font-family: Arial, sans-serif; max-width: 480px; margin: auto; padding: 24px;">
        <h2 style="color: #7c3aed;">Hello ${name},</h2>
        <p>You requested a password reset for your <strong>Dalal</strong> account.</p>
        ...
        <hr style="border: none; border-top: 1px solid #e5e7eb; margin: 24px 0;" />
        <p style="color: #9ca3af; font-size: 12px;">Dalal — Your beauty & grooming platform</p>
      </div>
    `;
  ...
  const html = `
    <div dir="rtl" style="max-width:600px;margin:0 auto;font-family:Tajawal,sans-serif;background:#faf5ff;padding:20px;border-radius:16px">
      <div style="text-align:center;padding:30px">
        <h1 style="color:#7c3aed;margin:0"> دلال</h1>
        <p style="font-size:20px;color:#111827;margin-top:16px">مرحباً ${name}!</p>
        <p style="color:#6b7280;line-height:1.8">
          شكراً لانضمامكِ إلى دلال — منصتكِ الأولى لحجز خدمات التجميل في السعودية.
        </p>
        ...
        <p style="color:#9ca3af;font-size:12px;margin-top:24px">دلال — منصة التجميل الأولى في السعودية</p>
      </div>
    </div>`;
