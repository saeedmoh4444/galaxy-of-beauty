...
export const mobileCustomerBMessages = {
  ...
  'mobile.video.waiting-peer': { ar: 'بانتظار انضمام الطرف الآخر…', en: 'Waiting for the other side to join…' },
  ...
  'mobile.video.permission-denied': { ar: 'تعذر الوصول إلى الكاميرا أو الميكروفون', en: 'Could not access camera or microphone' },
