// Mobile admin screens. Populated by the mobile sweep agents.
...
export const mobileAdminMessages = {
  ...
  'mobile.admin.analytics.users': { ar: 'مستخدم', en: 'Users' },
  ...
  'mobile.admin.audit-log.subtitle': {
    ar: 'مراقبة جميع التغييرات في المنصة',
    en: 'Monitor all platform changes',
  },
  'mobile.admin.audit-log.tag-create': { ar: 'إنشاء', en: 'Create' },
  'mobile.admin.audit-log.tag-delete': { ar: 'حذف', en: 'Delete' },
  'mobile.admin.audit-log.tag-export': { ar: 'تصدير', en: 'Export' },
  ...
  'mobile.admin.categories.services-count': { ar: '{count} خدمات', en: '{count} services' },

  // ---- Blog ----
  'mobile.admin.blog.load-error': { ar: 'فشل تحميل المقالات', en: 'Failed to load posts' },

  // ---- Campaigns ----
  'mobile.admin.campaigns.load-error': { ar: 'فشل تحميل الحملات', en: 'Failed to load campaigns' },
  'mobile.admin.campaigns.active': { ar: 'نشط', en: 'Active' },
  'mobile.admin.campaigns.inactive': { ar: 'غير نشط', en: 'Inactive' },

  // ---- CMS ----
  'mobile.admin.cms.load-error': { ar: 'فشل تحميل المحتوى', en: 'Failed to load content' },
  ...
  'mobile.admin.beauty-events.upcoming': { ar: 'قادمة', en: 'Upcoming' },
  'mobile.admin.beauty-events.active-f': { ar: 'نشطة', en: 'Active' },
  ...
  'mobile.admin.cashback.rule-summary': {
    ar: 'استرداد {rate}% — حد أدنى {min} ر.س',
