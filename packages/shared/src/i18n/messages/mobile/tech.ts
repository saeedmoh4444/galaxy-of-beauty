// Mobile technician screens. Populated by the mobile sweep agents.
...
export const mobileTechMessages = {
  ...
  'mobile.tech.calendar.day-tuesday': { ar: 'الثلاثاء', en: 'Tue' },
  'mobile.tech.calendar.day-wednesday': { ar: 'الأربعاء', en: 'Wed' },
  'mobile.tech.calendar.day-thursday': { ar: 'الخميس', en: 'Thu' },
  ...
  // ---- Pro Tools ----
  'mobile.tech.pro-tools.title': { ar: 'أدوات المحترفات', en: 'Pro Tools' },
  'mobile.tech.pro-tools.subtitle': {
    ar: 'أدوات احترافية لإدارة أعمالكِ',
    en: 'Professional tools to manage your business',
  },
  'mobile.tech.pro-tools.load-error': { ar: 'فشل تحميل الأدوات', en: 'Failed to load tools' },
  'mobile.tech.pro-tools.total-clients': { ar: 'إجمالي العملاء', en: 'Total Clients' },
  'mobile.tech.pro-tools.regular-clients': {
    ar: '{count} عميلات دائمات',
    en: '{count} regular clients',
  },
  'mobile.tech.pro-tools.monthly-revenue': { ar: 'الإيرادات الشهرية', en: 'Monthly Revenue' },
  'mobile.tech.pro-tools.last-month': { ar: 'الشهر الماضي: {amount}', en: 'Last month: {amount}' },
  'mobile.tech.pro-tools.avg-rating': { ar: 'متوسط التقييم', en: 'Average Rating' },
  'mobile.tech.pro-tools.out-of-five': { ar: 'من 5 نجوم', en: 'out of 5 stars' },
  'mobile.tech.pro-tools.expenses': { ar: 'المصروفات', en: 'Expenses' },
  'mobile.tech.pro-tools.this-month': { ar: 'هذا الشهر', en: 'This Month' },
  'mobile.tech.pro-tools.bookings-log': { ar: 'سجل الحجوزات', en: 'Bookings Log' },
  'mobile.tech.pro-tools.view-all-bookings': { ar: 'عرض كل الحجوزات', en: 'View All Bookings' },
  'mobile.tech.pro-tools.wallet-earnings': { ar: 'المحفظة والأرباح', en: 'Wallet & Earnings' },
  'mobile.tech.pro-tools.available-balance': {
    ar: 'الرصيد المتاح للسحب',
    en: 'Available balance for withdrawal',
  },
  'mobile.tech.pro-tools.gallery': { ar: 'المعرض', en: 'Gallery' },
  'mobile.tech.pro-tools.photos-work': { ar: 'صور وأعمال', en: 'Photos & work' },
  'mobile.tech.pro-tools.manage-schedule': {
    ar: 'إدارة جدول المواعيد',
