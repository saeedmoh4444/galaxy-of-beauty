...
pnpm --filter @galaxy/api test        # ✅ 41 files, 578 tests
pnpm --filter @galaxy/api test:coverage  # ✅ exit 0, thresholds 52/68/49/52 enforced
